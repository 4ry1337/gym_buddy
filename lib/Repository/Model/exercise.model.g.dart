...
void _exerciseSerialize(
  ...
  writer.writeLong(offsets[0], object.kg);
...
Exercise _exerciseDeserialize(
  ...
  final object = Exercise(
    kg: reader.readLongOrNull(offsets[0]),
    name: reader.readStringOrNull(offsets[1]) ?? '',
    reps: reader.readLongOrNull(offsets[2]),
    sets: reader.readLongOrNull(offsets[3]),
    time: reader.readLongOrNull(offsets[4]),
  );
  return object;
}
